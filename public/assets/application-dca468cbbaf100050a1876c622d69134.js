...
(function() {
  $(function() {
    var $container1, $container2, $container3, $container4, bar_cfg, handler, line_cfg, pie_cfg, typed_cfg;
    line_cfg = {
      chart: {
        type: "line"
      },
    ...
    if (typeof container1 !== "undefined" && container1 !== null) {
    ...
    if (typeof container3 !== "undefined" && container3 !== null) {
...
(function() {
  $(function() {
    var draw_user_in_map, fill_table, hide_groups, load_parents, load_user_in_map, show_groups;
    ...
    draw_user_in_map = function(data) {
      var address, geocoder, initCenter, map;
    ...
    $('.page_number').click(function(e) {
      ...
      return $.ajax({
        url: "/api/users",
        data: {
          role: getURLParameter('role') !== 'jugador' ? getURLParameter('role') : '',
          page: page_number
        },
        success: function(data) {
          console.log(data);
    ...
    fill_table = function(table_id, data) {
      ...
      return $.each(data, function(i, item) {
        var cleared_tds, tds;
        tds = '<td ><a href="/users/' + data[i].id + '"><span class="glyphicon glyphicon-eye-open"></span></a></td>' + '<td ><a class="table-action" data-confirm="¿Está seguro que desea eliminar?" data-method="delete" href="/users/' + data[i].id + '" rel="nofollow">' + '<span class="glyphicon glyphicon-remove"></span></a></td>' + '<td><p class="small"> ' + data[i].register_date + " </p></td> " + '<td><p class="small"> ' + data[i].ife_key + " </p></td> " + '<td><p class="small"> ' + data[i].bird + " </p></td> " + '<td><p class="small"> ' + data[i].name + " </p></td> " + '<td><p class="small"> ' + data[i].first_name + " </p></td> " + '<td><p class="small"> ' + data[i].last_name + " </p></td> " + '<td><p class="small"> ' + data[i].gender + " </p></td> " + '<td><p class="small"> ' + data[i].age + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].section) + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].dto_fed) + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].dto_loc) + " </p></td> " + '<td><p class="small"> ' + data[i].city + " </p></td> " + '<td><p class="small"> ' + data[i].street_number + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].outside_number) + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].internal_number) + " </p></td> " + '<td><p class="small"> ' + data[i].neighborhood + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].zipcode) + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].phone) + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].cellphone) + " </p></td> " + '<td colspan="2">' + data[i].email + " </p></td> " + '<td><p class="small"> ' + data[i].role + " </p></td> " + '<td><p class="small"> ' + data[i].parent + " </p></td> ";
