  ...
  $(function() {
    ...
    fill_table = function(table_id, data) {
      ...
      return $.each(data, function(i, item) {
        var cleared_tds, tds;
        tds = '<td><p class="small"> ' + data[i].register_date + " </p></td> " + '<td><p class="small"> ' + data[i].ife_key + " </p></td> " + '<td><p class="small"> ' + data[i].bird + " </p></td> " + '<td><p class="small"> ' + data[i].name + " </p></td> " + '<td><p class="small"> ' + data[i].first_name + " </p></td> " + '<td><p class="small"> ' + data[i].last_name + " </p></td> " + '<td><p class="small"> ' + data[i].gender + " </p></td> " + '<td><p class="small"> ' + data[i].age + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].section) + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].dto_fed) + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].dto_loc) + " </p></td> " + '<td><p class="small"> ' + data[i].city + " </p></td> " + '<td><p class="small"> ' + data[i].street_number + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].outside_number) + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].internal_number) + " </p></td> " + '<td><p class="small"> ' + data[i].neighborhood + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].zipcode) + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].phone) + " </p></td> " + '<td><p class="small"> ' + parseInt(data[i].cellphone) + " </p></td> " + '<td colspan="2">' + data[i].email + " </p></td> " + '<td><p class="small"> ' + data[i].role + " </p></td> " + '<td><p class="small"> ' + data[i].parent + " </p></td> " + '<td ><a href="/users/' + data[i].id + '"><span class="glyphicon glyphicon-eye-open"></span></a></td>' + '<td ><a class="table-action" data-confirm="¿Está seguro que desea eliminar?" data-method="delete" href="/users/' + data[i].id + '" rel="nofollow">' + '<span class="glyphicon glyphicon-remove"></span></a></td>';
