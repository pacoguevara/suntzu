...
class User < ActiveRecord::Base
  ...
  def self.import_players(file)
    ...
    (2..spreadsheet.last_row).each do |i|
      ...
      street_number = spreadsheet.cell(i,8)
      outside_number = spreadsheet.cell(i,9)
      internal_number = spreadsheet.cell(i,10)
      neighborhood = spreadsheet.cell(i,11)
      section = spreadsheet.cell(i,12)
